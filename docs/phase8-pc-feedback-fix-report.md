...
- corrected preview tag: `phase8-pc-recheck-ready-v2-2026-08-24`
- diagnostic tags: `phase8-pc-feedback-fixed-2026-08-24`、`phase8-pc-recheck-ready-2026-08-24`（`rawcdn.githack.com` が旧manifestを返すCDN cache混在を安全gateが検出したためPC確認には使わない。履歴をforce変更せず保存）
