...
- Phase 6 confirmed that Vite is unnecessary for the offline data foundation. Reconsider it only if a later browser prototype demonstrates a concrete advantage over plain generated scripts for module/chunk/hash management. Phase 7 has not started.
