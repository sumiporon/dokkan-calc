/** Only generates the new offline proof; preserves all existing preview/XPI outputs. */
...
const out = path.join(root, 'generated/phase11/partial'); await mkdir(out, { recursive: true });
...
for (const [entry, name] of [['src/prototype/phase11-partial-api.mjs', 'api.mjs'], ['prototypes/phase11-partial/app.mjs', 'app.mjs']]) {
...
console.log('Offline partial prototype built: generated/phase11/partial/ (no existing artifacts regenerated)');
